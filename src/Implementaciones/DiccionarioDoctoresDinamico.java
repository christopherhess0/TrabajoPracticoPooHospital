...
public class DiccionarioDoctoresDinamico implements DiccionarioDoctoresTda {
    ...
    public void agregar(String clave, DatosMedico DatosMedico) {
        Nodo n = buscar(clave);
        if (n == null) {
            n = new Nodo();
            n.clave = clave;
            n.valor = new DatosMedico();
            n.valor.especialidad = DatosMedico.especialidad;
            n.valor.horaInicio = DatosMedico.horaInicio;
            n.valor.horaFin = DatosMedico.horaFin;
            n.sig = primero;
            primero = n;
        } else {
            n.valor.especialidad = DatosMedico.especialidad;
